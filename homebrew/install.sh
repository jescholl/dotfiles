...
brew_packages="awscli grc ipcalc tcping dhcping csshx gnu-tar wget nmap mtr httpie exercism jq the_silver_searcher autojump node git-standup shellcheck tflint vim tfenv coreutils eza bat gnupg"
